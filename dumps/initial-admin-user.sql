INSERT INTO `wc_identity` (`id`, `last_name`, `first_name`, `email`, `official_group`) VALUES
('b7f5d7fc-1966-499a-a32d-cfbca4b849c8',	'Degoule',	'Jean-Patrick',	'admin@admin.fr', 'laboratoire');
